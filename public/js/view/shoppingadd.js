...
define([
    ...
    'bootstrap-cal',
            ...
            function (nougat, _, $, Backbone, BaseView, ViewUtil, Validation, ErrorDisplay,GlobalSpace) {
                var shoppingAddView = BaseView.extend({
                el:"#shoppingAdd",
                       events: {
                        'keypress #cc_fourdigit':'updateCCClass',
                        'change #shopping_status':GlobalSpace.dropdownSpanUpdate,
                ...
                initialize: function(){   
                        ...
                        $('#cal_shopping_date').datetimepicker({pickTime: false});
                } ,//close init();
